...
class ItalyStandingsScraper(BaseScraper):
    def scrape(self, url="https://www.mackolik.com/puan-durumu/italya-serie-a/2025-2026/1r097lpxe0xn03ihb7wi98kao"):
        data = []
        try:
            self.start_browser()
            self.navigate(url)
            ...
            for i, row in enumerate(rows):
                ...
                if len(text_cells) < 8: continue

                try:
                    rank = text_cells[0]
                    # Determine Team Name Index
                    # Usually: [Rank] [Logo/Empty] [Team] [O] ...
                    team_idx = 2
                    ...
                    if len(text_cells) > team_idx + 8:
                        ...
                        row_data = {
                            ...
                            "team": team_name,
                            "played": played,
                            "won": won,  # Corrected from text_cells logic
                            "drawn": drawn,
                            "lost": lost,
                            "goals_for": goals_for,
            ...
            print(f"Error in ItalyStandingsScraper: {str(e)}")
        finally:
            self.close_browser()
